<div class="well">
    ...
    <? foreach($checkins as $ch)
    {
        ...
        if($ch->public == 1)
        {
            ...
            echo "Maksymalny czas rezerwacji: ". secondsToText($ch->reservations, true, true)."<br />";
            echo "Maksymalny czas odprawy: ". secondsToText($ch->maxCheckin, true, true)."<br />";
            echo "Minimalny czas odprawy: ". secondsToText($ch->minCheckin, true, true)."<br />";
