...
class Helper_DbBackup {
     ...
     * Retorna o caminho completo do arquivo SQL gerado.
     *  * Orientaçao: http://davidwalsh.name/backup-mysql-database-php
     *
     * @return string full path
     */
    ...
    /**
     * Mysqldump - Cria opoes
     * Opçao [--opt --host=localhost --user=username --password=passwd db > path/db_date.sql]
     *
