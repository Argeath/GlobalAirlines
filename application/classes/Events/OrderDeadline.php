    ...
    protected function doWork() {
        ...
        if ($userOrder->loaded() && $userOrder->user_id == $this->event->user->id) {
            ...
            if ($punish) {
                ...
                $msg = "Zapłacono karę - " . formatCash($punish) . " " . WAL . " za zlecenie z miasta " .
                    Helper_Map::getCityName($order->from) . " do miasta " .
                    Helper_Map::getCityName($order->to) . ".";

                $this->event->user->sendMiniMessage("Zapłacono karę za niewykonanie zlecenia.", $msg, $order->deadline);
