	...
	public function execute()
	{
		...
		if ( ! method_exists($this, $action))
		{
			throw HTTP_Exception::factory(404,
				'The requested URL :uri was not found on this server. Controller: :contr, action: :action',
				array(':uri' => $this->request->uri(), ':action' => $action, ':contr' => $this->request->controller())
